...
// You can choose which exact pins to use, and how many.  This
// makes for tidy and easy PCB layout.  It does slow things down a
// tiny bit, but this is not a big colourful panel with lots of pixels
// to throw around and so isn't a real problem.
...
/** Panel mapping selection defines.
  *
  * Un-comment whichever suits your display characteristics.
  */  
// #define HD_PANEL_8X1
...
// #define HD_PANEL_20X4		// Oh the darling of my projects!
...
/** Set this define to compile in Lite mode.
  ...
  * memory usage.  Oh what a small world we live it!
  */
// #define LCD_LITE
...
// Notice the strange arrangement HD44780 Controllers use.
//
...
/** Function Declarations
  ...
  * 
  * You will find these functions in HD44780.c.
  */
